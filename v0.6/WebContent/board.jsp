...
if (kinds == null || kinds.equals(""))	kinds = "1"; //값이 없으면 1로
switch (kinds)
{
	case "0": 
		strkind   = "Notice";
...
//select절
String str_select = "";
str_select += "select bno,b.no,kinds,title,lang,date,views,";
str_select += "date(start_date) as start_date,date(end_date) as end_date, ";
str_select += "(select count(*) from reply where bno = b.bno) as reply_count, ";
str_select += "(select count(*) from attach where bno = b.bno) as attach, ";
str_select += "u.id,u.nickname,u.user_rank ";
