			...
			<div>
				...
				<div class="paging">
					<ul>
						...
						{
							%><li><a href="withus.jsp?kinds=<%= kinds %>&page=<%= start_block - 1 %>">◀</a></li><%
						}
						...
						for (int pageno = start_block; pageno <= end_block; pageno++)
						{
							%>
							<li>
								<a href="withus.jsp?kinds=<%= kinds %>&page=<%= pageno %>" <% if (cur_page == pageno) %>class="now"<%; %>>
									<%= pageno %> 
								</a>
							</li>
							<%
						...
						{
							%><li><a href="withus.jsp?kinds=<%= kinds %>&page=<%= end_block + 1 %>">▶</a></li><%
						}
						%>
					</ul>
				</div>
